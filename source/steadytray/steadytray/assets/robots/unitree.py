...
_ASSETS_DIR = Path(__file__).resolve().parents[1]
UNITREE_MODEL_DIR = (_ASSETS_DIR / "unitree_model").as_posix()
STEADYTRAY_USD_DIR = (_ASSETS_DIR / "usds").as_posix()
...
UNITREE_G1_23DOF_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUsdFileCfg(
        usd_path=f"{STEADYTRAY_USD_DIR}/g1_23dof_side_tray_holder.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.8),
        joint_pos={
